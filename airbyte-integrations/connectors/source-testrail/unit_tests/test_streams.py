...
import pytest
from source_testrail.source import TestrailStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TestrailStream, "path", "v0/example_endpoint")
    mocker.patch.object(TestrailStream, "primary_key", "test_primary_key")
    mocker.patch.object(TestrailStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TestrailStream()
